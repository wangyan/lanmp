...
body{text-align: center; margin: 0 auto; padding: 0; background-color:#EEE;font-size:12px;font-family:Tahoma, Arial}
...
table{clear:both;padding: 0; margin: 15px 0 10px; border-collapse:collapse; border-spacing: 0;}
...
.barli_black{background:Teal; height:5px; margin:0px; padding:0;}
...
<table width="100%" cellpadding="3" cellspacing="0">
  ...
  ?>
	...
	<table width="100%" cellpadding="3" cellspacing="0" align="center">
		<tr>
			<td>&copy; <?php echo date("Y",time());?> PHP Prober Yahei.Net <?php echo $version; ?> All Rights Reserved.</td>
